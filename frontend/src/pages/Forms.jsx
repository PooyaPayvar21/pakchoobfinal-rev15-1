...
const Forms = () => {
  ...
  const [userWorktype, setUserWorktype] = useState(null);
  ...
  useEffect(() => {
    const loadFormData = async () => {
      try {
        ...
        const additionalRoles = localStorage.getItem("additional_roles");
        ...
        setUserWorktype(worktype.toLowerCase());
        ...
        } else if (worktype.toLowerCase() === "generalmechanic") {
          // For generalmechanic, show metalworking, paint, and tarashkari forms
          filteredForms = filteredForms.filter((form) => {
            const formWorktype =
              form.form_type === "pm_form" ? form.pmworktype : form.worktype;
            return ["metalworking", "paint", "tarashkari"].includes(
              formWorktype?.toLowerCase()
            );
          });
          console.log(
            "Forms after generalmechanic filtering:",
            filteredForms.length
          );
        } else {
        ...
        console.log("Final form counts:", counts);
