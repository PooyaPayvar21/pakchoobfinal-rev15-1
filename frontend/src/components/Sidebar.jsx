  ...
  return (
    <>
      <motion.div
        ...
        } bottom-0 md:bottom-auto bg-gray-800 bg-opacity-95 backdrop-blur-md shadow-lg md:shadow-none`}
        animate={{
            ...
            {menuItems &&
              menuItems.map((item) => (
                <Link key={item.href} to={item.href}>
                  ...
                  >
                    <motion.div
                      className={`flex items-center p-2 md:p-4 text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors ${
                        !isSidebarOpen
                    ...
                    >
                      <div className="flex items-center gap-3 relative">
                        ...
                        <AnimatePresence mode="wait">
                          {isSidebarOpen && (
                            <motion.span
                              className="text-xs md:text-sm whitespace-nowrap text-gray-100"
                              initial={{ opacity: 0 }}
                              animate={{ opacity: 1 }}
                              exit={{ opacity: 0 }}
                              transition={{
